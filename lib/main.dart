...
class _MyAppState extends State<MyApp> {
                  ...
                  for (int i = 0; i < listOfCountry.length; i++)
                    DropDownList(
                      call: () {
                        ...
                        countryName = listOfCountry[i]['name']!.toUpperCase();
                        getNews();
                      },
  ...
  Future<void> getApiData(String url) async {
  ...
  Future<void> getNews({
    ...
    baseUrl += country == null ? 'country=in&' : 'country=$country&';
    baseUrl += category == null ? '' : 'category=$category&';
    ...
    if (searchKey != null) {
      ...
      category = null;
      baseUrl =
          'https://newsapi.org/v2/top-headlines?pageSize=10&page=$pageNum&q='
              '$searchKey&apiKey='+apiKey;
    }
    //print(baseApi);
    getApiData(baseUrl);
  }
